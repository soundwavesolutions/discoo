  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        <a className="text-[#2477ab] text-base block">Forgot User ID / Forgot Password</a>
        <a className="text-[#2477ab] text-base block">Activate Credit Card</a>
        <a className="text-[#2477ab] text-base block">Register Your Account</a>
      </div>
    </FormLayout>
  );
};
